...
export default async function EditDocumentPage({
  ...
  // Eigene Dateien für Anhänge
  const myAssets = await prisma.fileAsset.findMany({
    where: {
      OR: [
        { ownerId: session.user.id, trashedAt: null, variant: "original" },
        { isGlobal: true, trashedAt: null, variant: "original" },
      ]
    },
